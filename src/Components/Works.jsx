    ...
    <div className="works">
      <div className="works__flex">
        ...
        <div className="works__right">
          ...
          <div className="works__button__flex">
            <button
              className="works__button works__github"
              onClick={() => {
                window.open("https://github.com/LeonG11", "_blank");
              }}
            >
              <svg
            ...
            <button
              className="works__button works__behance"
              onClick={() => {
                window.open("https://www.behance.net/juliakostyleva", "_blank");
              }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
